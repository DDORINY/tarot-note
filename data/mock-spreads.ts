...
export const tarotSpreads: TarotSpread[] = [
  ...
  },
  {
    id: "four-card",
    name: "4카드 배열",
    description: "흐름에 조언을 더해 현실적인 선택을 돕습니다.",
    cardCount: 4,
    category: "basic",
    isPremium: false,
    positions: [
  ...
  },
  {
    id: "five-card",
    name: "5장 배열",
    description: "문제의 원인과 결과까지 균형 있게 보는 배열입니다.",
    cardCount: 5,
    category: "insight",
    isPremium: true,
    positions: [
      ...
      pos(3, "문제의 핵심", "가장 깊이 봐야 할 본질", 50, 50, 0, 3),
      pos(4, "가까운 미래", "곧 나타날 가능성", 74, 48, 8),
      pos(5, "결과", "현재 흐름이 이어질 때의 도착점", 50, 80)
    ]
  },
  {
    id: "magic-seven",
    name: "매직 세븐 스프레드",
    description: "장애물과 해결책을 함께 읽는 7장 배열입니다.",
    cardCount: 7,
    category: "premium",
    isPremium: true,
    positions: [
      ...
      pos(4, "해결책/충고", "상황을 풀기 위한 실질적 조언", 54, 24, 2, 3),
      pos(5, "현재상태의 영향", "지금 태도가 만드는 파장", 66, 34, 6),
      pos(6, "반대/장애물", "주의해야 할 저항과 방해", 78, 54, 10),
  ...
  },
  {
    id: "celtic-cross",
    name: "켈틱 크로스 스프레드",
    description: "복합적인 고민의 배경, 태도, 외부 영향, 결과를 깊게 봅니다.",
    cardCount: 10,
    category: "premium",
    isPremium: true,
    positions: [
      pos(1, "현재 상황", "질문을 둘러싼 현재 핵심", 36, 50, 0, 2),
      pos(2, "장애물/문제점", "가로막는 이슈와 긴장", 36, 50, 90, 3),
      pos(3, "내면/기반/과거 배경", "깊은 동기와 기반", 36, 76),
      pos(4, "가까운 과거", "최근 지나온 영향", 16, 50, -6),
      pos(5, "목표/가능성", "의식하는 목표와 가능성", 36, 24),
      pos(6, "가까운 미래", "곧 나타날 흐름", 56, 50, 6),
      pos(7, "나의 태도", "내가 취하고 있는 태도", 78, 82),
      pos(8, "외부 영향", "주변 사람과 환경", 78, 62),
      pos(9, "희망과 두려움", "기대와 불안", 78, 42),
      pos(10, "최종 결과", "전체 흐름의 도착 가능성", 78, 22)
    ]
  },
  {
    id: "flower-twelve",
    name: "12장 플라워 스프레드",
    description: "한 해의 흐름과 조심할 점, 최종 조언을 꽃 모양으로 펼칩니다.",
    cardCount: 12,
    category: "premium",
    isPremium: true,
    positions: [
      pos(1, "비겁", "나 자신과 경쟁, 독립성의 흐름", 50, 18),
      pos(2, "식상", "표현과 결과물, 즐거움의 흐름", 68, 26, 8),
      pos(3, "재성", "돈과 현실적 관계의 흐름", 78, 44, 12),
      pos(4, "관성", "책임과 사회적 역할의 흐름", 74, 64, 8),
      pos(5, "인성", "배움과 보호, 회복의 흐름", 60, 78, 4),
      pos(6, "1분기", "초반 흐름", 40, 78, -4),
      pos(7, "2분기", "봄에서 여름으로 넘어가는 흐름", 26, 64, -8),
      pos(8, "3분기", "중반 이후의 확장과 조정", 22, 44, -12),
      pos(9, "4분기", "마무리와 결실의 흐름", 32, 26, -8),
      pos(10, "가장 조심해야 할 것", "반복되기 쉬운 주의점", 50, 42, 0, 3),
